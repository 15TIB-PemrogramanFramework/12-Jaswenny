          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse navbar-right">
              <ul class="nav navbar-nav link-effect">
				...
				<li> <a href="#hm"> <?php echo $this->session->userdata('username'); ?> </a> </li>
				<li> <a href="<?php echo site_url('Login/logout');?>"> Logout lll </li>
              </ul>
...
<div class="about-me" id="about"> 
	<h3 class="text-center slideanim">About My </h3>
	<div class="container">
		<div class="row">
